    ...
    if t == "add_goal":
        ...
        if action.get("deadline"):
            try:
                ...
                add_event(f"Deadline: {action['title']}", dl.replace(hour=9), dl.replace(hour=10), action.get("description",""), "Niels AI agenda", skip_if_overlap=True)
        ...
        try:
            ...
            add_event(action["title"], start, end, action.get("description",""), "Niels AI agenda", skip_if_overlap=True)
